...
export default function UserItem({ 
    ...
    return (
        <tr>
            ...
            <button className="btn delete-btn" title="Delete" onClick={() => userDeleteClickHandler(user._id)}>
            ...
            <button className="btn info-btn" title="Info" onClick={() => userDetailsClickHandler(user._id)}>
